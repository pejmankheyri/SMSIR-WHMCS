...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_AfterRegistrarRegistrationFailed'),
        'english' => Lang::trans('smsir_hook_title_AfterRegistrarRegistrationFailed')
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} {lastname} عزیز، دامنه ({domain}) ثبت نشد ! لطفا مجددا تلاش کنید',
