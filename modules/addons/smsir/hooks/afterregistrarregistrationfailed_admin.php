...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_AfterRegistrarRegistrationFailed_admin'),
        'english' => Lang::trans('smsir_hook_title_AfterRegistrarRegistrationFailed_admin')
    ),
    'type' => 'admin',
    'extra' => '',
    'defaultmessage' => 'خطایی در هنگام ثبت دامنه جدید رخ داده است. {domain}',
    'variables' => '{domain}'
);
