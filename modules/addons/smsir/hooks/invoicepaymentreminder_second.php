...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_InvoicePaymentReminder_secondoverdue'),
        'english' => Lang::trans('smsir_hook_title_InvoicePaymentReminder_secondoverdue')
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} {lastname} عزیز، فاکتور به تاریخ {duedate} نیاز به پرداخت دارد. برای اطلاعات بیشتر به وبسایت مراجعه نمایید.',
