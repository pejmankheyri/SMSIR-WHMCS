...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_ClientLogin_admin'),
        'english' => Lang::trans('smsir_hook_title_ClientLogin_admin')
    ),
    'type' => 'admin',
    'extra' => '',
    'defaultmessage' => '({firstname} {lastname}) ، وارد سایت شد',
...
if (!function_exists('ClientLogin_admin')) {
    function ClientLogin_admin($args)
    {
		...
		$type = 'login';
		if($apiparamsarray['loginwithverification'] == "on"){
