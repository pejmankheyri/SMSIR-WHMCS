...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_AfterModuleChangePackage'),
        'english' => Lang::trans('smsir_hook_title_AfterModuleChangePackage')
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} {lastname} عزیز،  سفارش شما تغییر یافت ({domain}).',
