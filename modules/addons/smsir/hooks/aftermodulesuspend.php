...
$hook = array(
    ...
    'description' => array(
        'farsi' => Lang::trans('smsir_hook_title_AfterModuleSuspend'),
        'english' => Lang::trans('smsir_hook_title_AfterModuleSuspend')
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} {lastname} عزیز، سرویس شما به حالت تعلیق درآمده است. ({domain})',
